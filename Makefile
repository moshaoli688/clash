...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/moshaoli688/clash/constant.Version=$(VERSION)" \
		-X "github.com/moshaoli688/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
